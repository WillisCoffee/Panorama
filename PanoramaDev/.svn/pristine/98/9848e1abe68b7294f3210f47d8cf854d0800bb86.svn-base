...
public class DlgGererEtudiant extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lblDateInscription = new javax.swing.JLabel();
        txfDateInscription = new javax.swing.JTextField();
        ...
        lblDateInscription.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        lblDateInscription.setText("Date inscription :");

        txfDateInscription.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        txfDateInscription.setPreferredSize(new java.awt.Dimension(68, 25));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlContenuLayout.createSequentialGroup()
                ...
                .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlContenuLayout.createSequentialGroup()
                        ...
                        .addComponent(lblDateInscription))
                    .addGroup(pnlContenuLayout.createSequentialGroup()
                ...
                .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlContenuLayout.createSequentialGroup()
                        .addComponent(txfDateInscription, javax.swing.GroupLayout.DEFAULT_SIZE, 89, Short.MAX_VALUE)
                        .addGap(70, 70, 70))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlContenuLayout.createSequentialGroup()
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlContenuLayout.createSequentialGroup()
                        .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txfTelephone, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        pnlContenuLayout.setVerticalGroup(
            ...
            .addGroup(pnlContenuLayout.createSequentialGroup()
                ...
                .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(lblPhotographie)
                    .addComponent(lblDateInscription)
                    .addComponent(txfDateInscription, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(37, 37, 37))
        );
...
//                Utilisateur unUtilisateur = _facadeUtilisateur.findByNas(_utilisateur.getNas());
...
//                int idUtili = unUtilisateur.getIdUtilisateurPK();
    ...
    public void deseactiverChamps(boolean pModifier)
    {
        
        txfNAS.setEnabled(pModifier);
    }
                                                ...
                                                if (lbValide) {
                                                    ...
                                                    if (lbValide) {
                                                        ...
                                                        if (lbValide) {
                                                            ...
                                                            if (lbValide) {
                                                                lbValide = validerDate(txfDateInscription.getText());
                                                                if(lbValide){
                                                                lbTerminer = true;
                                                                }else{
                                                                    lblMessage.setText("Veuillez inscrire une date inscription valide aaaa-mm-jj");
                                                                    txfDateInscription.requestFocus();
                                                                }
                                                            } else {
                                                            ...
                                                            lblMessage.setText("Veuillez inscrire une adresse courriel valide tout en minuscule");
                                                            txfCourriel.requestFocus();
                                                        }
                                                    } else {
...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="Composant">
    ...
    private javax.swing.JLabel lblDateInscription;
    ...
    private javax.swing.JTextField txfDateInscription;
