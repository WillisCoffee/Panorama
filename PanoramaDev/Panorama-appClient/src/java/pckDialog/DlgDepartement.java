...
public class DlgDepartement extends javax.swing.JDialog {
    ...
    { 
        if (!validerNumDepartement(txfNumDepartement.getText()))
        {
            lblMessage.setText("Veuillez entrer un numéro de département valide.");
            return false;
        }
        if (!validerNom(txfNomDepartement.getText()))
        {
            lblMessage.setText("Veuillez enter un département valide.");
            return false;
        }
        if (!validerNom(txfResponsable.getText()))
        {
            lblMessage.setText("Veuillez entrer un nom de responsable valide.");
            return false;
        }
        return true;
    }
