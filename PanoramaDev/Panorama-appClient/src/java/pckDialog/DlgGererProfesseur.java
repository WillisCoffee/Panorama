...
import static pckValidation.Validation.validerNoBureau;
 ...
 * @author clocal
 */
public class DlgGererProfesseur extends javax.swing.JDialog {

    /**
     * Creates new form DlgGererProfesseur
     */
    ...
    List<Departement> _lstDepartement;
    UtilisateurFacadeRemote _facadeUtilisateur;
    CodePostalFacadeRemote _facadeCodePostal;
    DepartementFacadeRemote _facadeDepartement;
    Departement _departement;

    public DlgGererProfesseur(java.awt.Frame parent, boolean modal, 
            Professeur pProfesseur, List<Departement> pListDep, 
            UtilisateurFacadeRemote pFacadeUtilisateur, CodePostalFacadeRemote pFacadeCodePostal,
            DepartementFacadeRemote pFacadeDepartement) {
        super(parent, modal);
        _lstAdresse = new ArrayList<>();
        _lstDepartement = new ArrayList<>();
        _lstDepartement = pListDep;
        _facadeUtilisateur = pFacadeUtilisateur;
        _facadeCodePostal = pFacadeCodePostal;
        _facadeDepartement = pFacadeDepartement;
        _departement = pProfesseur.getIdDepartementFK();
        _professeur = pProfesseur;
        _utilisateur = pProfesseur.getIdUtilisateurFK();
        ...
        initComponents();
        lblMessage.setText("");
        if((_professeur != null) & (_utilisateur != null))
        {
            DateFormat myDate = new SimpleDateFormat("yyyy-MM-dd");
            String dateNaisance = myDate.format(_utilisateur.getDateNaissance());
            txfDateNaissance.setText(dateNaisance);
            String nomDep = _departement.getNomDep();
            String bigDecimalString = String.valueOf((_utilisateur.getCreditImpression()).doubleValue());
            txfCreImpression.setText(bigDecimalString);
            cmbDepartement.setSelectedItem(nomDep);
        }
    }
    ...
    private void initComponents() {
        ...
        lblNoEmploye = new javax.swing.JLabel();
        txfNumeroEmp = new javax.swing.JTextField();
        ...
        lblNoBureau = new javax.swing.JLabel();
        lblDepartement = new javax.swing.JLabel();
        txfNoBureau = new javax.swing.JTextField();
        ...
        setTitle("Gérer enseignant");
        setModal(true);
        setResizable(false);

        lblTitre.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        lblTitre.setText("Gérer enseignant");
        pnlTitre.add(lblTitre);

        getContentPane().add(pnlTitre, java.awt.BorderLayout.PAGE_START);

        lblNoEmploye.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        lblNoEmploye.setText("Numéro enseignant :");

        txfNumeroEmp.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        txfNumeroEmp.setPreferredSize(new java.awt.Dimension(0, 25));

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${professeur.numeroEmployePK}"), txfNumeroEmp, org.jdesktop.beansbinding.BeanProperty.create("text"));
        ...
        pwfMotPasse.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        ...
        lblCreditImpression.setText("Crédits impression :");
        ...
        lblNoBureau.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        lblNoBureau.setText("No bureau :");

        lblDepartement.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        lblDepartement.setText("Département :");

        txfNoBureau.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        txfNoBureau.setPreferredSize(new java.awt.Dimension(0, 25));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${professeur.bureau}"), txfNoBureau, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        cmbDepartement.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        cmbDepartement.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "List Département" }));
        cmbDepartement.setPreferredSize(new java.awt.Dimension(125, 25));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${departement.nomDep}"), cmbDepartement, org.jdesktop.beansbinding.BeanProperty.create("selectedItem"));
        bindingGroup.addBinding(binding);
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${unAdresse.rue}"), txfNomRue, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
        ...
        txaDispo.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        txaDispo.setRows(5);
        jScrollPane1.setViewportView(txaDispo);

        jLabel1.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        jLabel1.setText("Disponibilités :");

        jLabel7.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        jLabel7.setText("Poste :");

        txfPoste.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        txfPoste.setPreferredSize(new java.awt.Dimension(59, 25));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${professeur.numeroPosteProf}"), txfPoste, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
                ...
                .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(pnlContenuLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txfNomRue, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE)
                            .addComponent(pwfMotPasse, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(txfNom, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(cmbProvince, javax.swing.GroupLayout.Alignment.LEADING, 0, 1, Short.MAX_VALUE)))
                    .addGroup(pnlContenuLayout.createSequentialGroup()
                        .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(pnlContenuLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txfCourriel, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnlContenuLayout.createSequentialGroup()
                                        ...
                                        .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlContenuLayout.createSequentialGroup()
                                                ...
                                                .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    ...
                                                    .addComponent(lblNoEmploye, javax.swing.GroupLayout.Alignment.TRAILING)
                                                    .addComponent(jLabel7, javax.swing.GroupLayout.Alignment.TRAILING))))
                                        .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlContenuLayout.createSequentialGroup()
                                                .addGap(4, 4, 4)
                                                .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addComponent(txfVille, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                    .addComponent(txfCodePostal, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                    .addComponent(txfNumeroEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                    .addComponent(txfPrenom, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                    .addComponent(txfNoCiv, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                            .addGroup(pnlContenuLayout.createSequentialGroup()
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                    .addComponent(txfTelephone, javax.swing.GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE)
                                                    .addComponent(txfPoste, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                                ...
                                .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(lblNoBureau, javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(lblNAS, javax.swing.GroupLayout.Alignment.TRAILING))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txfCellulaire, javax.swing.GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE)
                            ...
                            .addComponent(txfNoBureau, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addGap(94, 94, 94))
        );
        pnlContenuLayout.setVerticalGroup(
            ...
            .addGroup(pnlContenuLayout.createSequentialGroup()
                ...
                .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblNoEmploye)
                    .addComponent(txfNumeroEmp, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblNom)
                ...
                .addGap(7, 7, 7)
                .addGroup(pnlContenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txfNoBureau, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblNoBureau)
    ...
    private void btnAccepterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAccepterActionPerformed
        ...
        if (lbValide) {
            ...
            if (lbValide) {
                ...
                _codePostal.setCodePostal(retournerCodePostal(txfCodePostal.getText()));
                ...
                _codePostal = _facadeCodePostal.findByCodePostal(_codePostal.getCodePostal());
                // Utilisateur
                if(_utilisateur == null)
                {
                ...
                _utilisateur.setCreditImpression(new BigDecimal(Double.parseDouble(txfCreImpression.getText())));
                _facadeUtilisateur.edit(_utilisateur);
               
                _utilisateur = _facadeUtilisateur.findByNas(_utilisateur.getNas());
                ...
                _adresse.setIdUtilisateurFK(_utilisateur);
                _adresse.setIdCodePostalFK(_codePostal);
                if(lbNew)
                {
                ...
                if(_professeur == null)
                {
                    _professeur = new Professeur();
                }
                _professeur.setNumeroEmployePK(txfNumeroEmp.getText());
                _professeur.setNumeroPosteProf(txfPoste.getText());
                _professeur.setBureau(txfNoBureau.getText());
                _professeur.setIdUtilisateurFK(_utilisateur);
                _professeur.setDisponibiliteProf(txaDispo.getText());
                String dept =(String) cmbDepartement.getSelectedItem().toString();
                Departement unDepartement = trouverDepartement(dept, _facadeDepartement);
                _professeur.setIdDepartementFK(unDepartement);
                setVisible(false);
                result = true;
            }
        }
                                ...
                                if (lbValide) {
                                    ...
                                    if (lbValide) {
                                        ...
                                        if (lbValide) {
                                            ...
                                            if (lbValide) {
                                                lbValide = validerNoBureau(txfNoBureau.getText());
                                                if (lbValide) {
                                                    ...
                                                    lblMessage.setText("Veuillez inscrire un numéro de bureau valide C-210");
                                                    txfNoBureau.requestFocus();
                                                }
                                            } else {
    ...
    private boolean validerLongeurChamp() {
        boolean lbValide = false;
        if ((txfNumeroEmp.getText().length() < 6) | (txfNumeroEmp.getText().length() > 6)) {
            lblMessage.setText("Veuillez inscrire un code d'employé de 6 caractères.");
            txfNumeroEmp.requestFocus();
            ...
            if (!lbNumero) {
                ...
                txfPoste.requestFocus();
            } else if (txfNoBureau.getText().length() < 2) {
                lblMessage.setText("Veuillez inscrire un numéro de bureau minimum 4 caractères");
                txfNoBureau.requestFocus();
    ...
    private Departement trouverDepartement(String psChaine, DepartementFacadeRemote pFacadeDepartement )
    {
        Departement unDepartement;
        try
        {
            unDepartement = pFacadeDepartement.findByNom(psChaine);
        }
        catch(Exception e)
        {
            unDepartement = null;
    ...
    public void setProfesseur(Professeur _professeur) {
        this._professeur = _professeur;
    }
    ...
    public List<Departement> getLstDepartement() {
        return _lstDepartement;
    }

    public void setLstDepartement(List<Departement> _lstDepartement) {
        this._lstDepartement = _lstDepartement;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgGererProfesseur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgGererProfesseur dialog = new DlgGererProfesseur(new javax.swing.JFrame(), true, null, null, null, null, null);
    ...
    private javax.swing.JLabel lblNoBureau;
    private javax.swing.JLabel lblNoEmploye;
